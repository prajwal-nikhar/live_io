...
async function bootstrap() {
  ...
  if (sentryDsn) {
    ...
    bootstrapLogger.warn(
      "SENTRY_DSN not provided. Operating without Sentry reporting.",
    );
  }
  ...
  bootstrapLogger.log(
    `🚀 ENTERPRISE QUIZ PLATFORM BACKEND BOOTSTRAPPED SUCCESSFULLY 🚀`,
  );
  ...
  bootstrapLogger.log(
    `📊 Socket.IO Adapter: ${useRedisAdapter ? "Redis Clustered" : "In-Memory (Single Node)"}`,
  );
  bootstrapLogger.log(
    `==================================================================`,
  );
