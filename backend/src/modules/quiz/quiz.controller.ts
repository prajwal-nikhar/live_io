...
export class QuizController {
  ...
  @UseGuards(AuthGuard('jwt'), RolesGuard)
  @Roles('HOST', 'ADMIN')
  async updateQuiz(@Param('id') id: string, @Request() req: any, @Body() body: any) {
  ...
  @UseGuards(AuthGuard('jwt'), RolesGuard)
  @Roles('HOST', 'ADMIN')
  async addQuestion(@Param('id') id: string, @Request() req: any, @Body() body: any) {
    if (!body.text) {
  ...
  @UseGuards(AuthGuard('jwt'), RolesGuard)
  @Roles('HOST', 'ADMIN')
  async updateQuestion(@Param('questionId') questionId: string, @Request() req: any, @Body() body: any) {
