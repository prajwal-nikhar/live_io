import { Controller, Get, Param, Query, UseGuards, Request, Response, Header, BadRequestException } from '@nestjs/common';
...
export class AnalyticsController {
  ...
  async exportCsvByQuery(
    ...
    try {
      ...
      if (!target) {
        throw new BadRequestException('Session ID or PIN query parameter is required');
      }
